...
const User = () => {
  ...
  const { user, carts, createdProducts, ownerProducts, transactionCarts } =
    useSelector(({ userModel, cartModel, productModel }) => ({
      user: userModel.user,
      carts: cartModel.carts,
      transactionCarts: cartModel.transactionCarts,
  ...
  const {
    ...
    getListTransactions: cartModel.getListTransactions,
              ...
              <Row>
                ...
                <Col>
                  ...
                  >
                    ...
                    <TabPane tab="Sold" key="4">
                      <div className="created">
                        <div className="created__content">
                          {transactionCarts.map((cart, index) => (
                            <div className="history-item" key={index}>
                              <Row>
                                <Col sm={1}>
                                  <h5>#{index + 1}</h5>
                                ...
                                <Col sm={3}>
                                  ...
                                  <p>New owner: {cart?.new_owner?.username}</p>
                                </Col>
                                <Col sm={2}>
                                  <p className="p1">
                                    <img
